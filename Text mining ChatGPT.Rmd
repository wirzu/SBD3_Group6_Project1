...
ggplot (plot_content_data1, aes (x=tweet_date, y=n_content)) + 
  ...
  ggtitle("Number of reviews covering the topic 'education' (per day)")
```
...
ggplot (plot_content_data2, aes (x=tweet_date, y=n_content)) + 
  geom_bar(stat = "identity")+ theme_minimal () + 
  ggtitle("Number of reviews covering the topic 'Consulting Company, 
...
ggplot (plot_content_data3, aes (x=tweet_date, y=n_content)) + 
  geom_bar(stat = "identity")+ theme_minimal () + 
  ggtitle("Number of reviews covering the topic 'Industry, Factories' (per day)")
```
We created a dictionary consisting of words related to the industry and factories. However, we found very few tweets containing these specific words. As a result, this graph does not provide substantial insights. Therefore, we have decided to disregard this particular dictionary.
...
ggplot (plot_content_data4, aes (x=tweet_date, y=n_content)) + 
  geom_bar(stat = "identity")+ theme_minimal () + 
  ggtitle("Number of reviews covering the topic 'Art' (per day)")
```
...
ggplot (plot_content_data5, aes (x=tweet_date, y=n_content)) + 
  geom_bar(stat = "identity")+ theme_minimal () + 
  ggtitle("Number of reviews covering the topic 'Finance, Banking' (per day)")
```
...
Erklärung einfügen Dictionary 2 Consulting Company, Digital Transformation senitment
...
Dictionary 4 (Art)")
```
Erklärung einfügen Dictionary 4 Art senitment
...
Dictionary 5 (Finance, Banking)")
```
Erklärung einfügen Dictionary 5 Finance, Banking senitment
