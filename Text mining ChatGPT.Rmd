...
ggplot(Users, aes(x = range, fill = range)) + 
  ...
  scale_x_discrete(labels = c("0-100", "101-500", "501-1500", "1501-5000", "5000+")) +
...
tweets$dic2 <-str_count(tweets$preprocessed_text, "chatbot|language modeling|ai|artificial intelligence|machine learning")
